...
def forward_propagation(X, parameters):
    ...
    FC2 = tf.contrib.layers.fully_connected(P, 120, activation_fn=None)
    FC3 = tf.contrib.layers.fully_connected(FC2, 84, activation_fn=None)
...
def initialize_parameters():
    ...
    W3 = tf.get_variable("W3", [5, 5, 16, 26], initializer=tf.contrib.layers.xavier_initializer(seed=0))
...
def create_cnn_3conv_fc3_model(n_H0,n_W0, n_C0, n_y):
